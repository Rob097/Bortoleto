        ...
        if (request instanceof HttpServletRequest) {
            ...
            try {
                ...
                if (pagamentodao == null) {
                    pagamentodao = new JDBCPagamentoDAO(connection);
                }
            ...
            if (session != null) {
                ...
                //Pagamento
                if (session.getAttribute("pagamentodao") == null || session.getAttribute("pagamentodao") != pagamentodao) {
                ...
                if (cookies != null) {
                    for (Cookie c : cookies) {
                        switch (c.getName()) {
                            ...
                            case ("varianti"):
                                ids = c.getValue();
                                session.setAttribute("varianti", ids);
                                break;
                            default: break;
                        }
                    }
