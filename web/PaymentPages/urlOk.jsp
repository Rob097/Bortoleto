<%-- 
    Document   : urlOk
    Created on : 16-mag-2019, 16.00.58
    Author     : Roberto97
--%>
...
<html>
    <head>
        ...
        <meta name="Description" content="Complimenti! Il tuo ordine è stato CONFERMATO con successo">
        <meta charset="UTF-8">
    ...
    <body class="text-center" style="margin: auto auto;">
        ...
        <div class="jumbotron" style="margin: auto auto;">
            <h1 class="display-3">Ordine confermato!</h1>
            <p class="lead"><strong>Assicurati di aver ricevuto l'email di conferma.</strong></p>            
            <p>Quando l'ordine verrà spedito riceverai un'email di notifica.</p>
            <hr>
            <p>
                Grazie per aver acquistato alla macelleria Dellantonio.<br>Se hai qualche domanda non esitare a <a href="<c:url value="/#contattaci"/>">contattarci</a>
            </p>
            <p class="lead">
            ...
            if (cookies != null) {
                for (Cookie cc : cookies) {
                    if (cc.getName().equals("carrello")) {
                        ...
                        request.getSession().setAttribute("carrello", "");
                    }
