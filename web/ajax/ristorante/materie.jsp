                ...
                <a class="buttonS" href="#materiePrime" onclick="backMaterie();" style='color: black; background-color: white;'>Torna indietro</a><br>
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <!-- INIZIO CAROUSEL -->
                                <div id="carousel${type.replace(' ', '')}" class="carousel slide" data-interval="6500">
        ...
        <script>
            ...
            switch (tipo) {
                ...
                default:
                    ...
                    break;
                case('La Carne'):
                    $('#firstCaptionH3').html("Il Cervo");
                    $('#firstCaptionP').html("Cervo🦌 cotto in barbecue, patata dolce🥔, sesamo nero🖤 e cardoncelli🍄");
                    $('#secondCaptionH3').html("Carne Cruda");
                    $('#secondCaptionP').html("Servita con i carletti🌿, ricotta fresca🍶 e mandorle speziate.");
                    $('#firstIMG').css("background-image", "linear-gradient(0deg,rgba(0, 0, 0, 0.45),rgba(0, 0, 0, 0.35)),url(/console/img/immagini_sito/ristorante/la-carne/manzo-al-sesamo.jpg)");
                    $('#secondIMG').css("background-image", "url(/console/img/immagini_sito/ristorante/la-carne/cervo.jpg)");
                    $('#thirdIMG').css("background-image", "url(/console/img/immagini_sito/ristorante/la-carne/carne-cruda.jpg)");
                    $('#text').html('<p>Nasciamo come <strong>ristorante macelleria</strong>&nbsp;e proprio per questo motivo la carne rappresenta la parte pi&ugrave; importante della nostra cucina. Tra i diversi tipi di carne che offriamo quelli che pi&ugrave; meritano attenzione sono sicuramente la <strong>carne rossa</strong> e la <strong>selvaggina</strong>.</p><p>Da sempre la <strong><a title="Macelleria Dellantonio" href="https://macelleriadellantonio.it/La-Macelleria" target="_blank">macelleria Dellantonio</a></strong> si basa sulla filosofia della <strong>filiera a km 0</strong>. Questo significa che la nostra qualit&agrave; nel piatto parte dai pascoli della Val di Fiemme dove vivono bovini 100% Italiani e locali. Da qui tutto avviene esclusivamente nei nostri laboratori di Predazzo dove&nbsp;ci preoccupiamo di <strong>frollare la carne</strong> e scegliere i tagli migliori per preparare&nbsp;<strong>secondi piatti di carne raffinati</strong> e salutari che vengono incontro alle esigenze dei palati pi&ugrave; fini mantenendo un perfetto equilibrio tra gustosit&agrave; e leggerezza.<br />Ci troviamo a 1000 metri, ai piedi delle <strong>Dolomiti</strong> e qui vivono molti animali selvatici come Cervi, Caprioli e Camosci. Anche in questo la macelleria Dellantonio punta sul km 0, per questo in autunno e primavera, quando i cacciatori iniziano la loro attivit&agrave;, il nostro menu si adegua alla <strong>stagione</strong> offrendo secondi piatti raffinati ottimi per una <strong>cena a base di carne</strong> locale.</p><p>&nbsp;</p>');
                    break;
                case('Fatto da noi'):
                    $('#firstCaptionH3').html("Pasta e fagioli “in raviolo”");
                    $('#firstCaptionP').html("Ravioli ripieni di crema di fagioli Borlotti, Brodo di carne al rosmarino, gocce di Trentingrana affumicato");
                    $('#secondCaptionH3').html("Millefoglie croccante");
                    $('#secondCaptionP').html(" Millefoglie croccante, crema soffice allo Yuzu 🍋, finocchietto🌿 e arachide🥜");
                    $('#firstIMG').css("background-image", "linear-gradient(0deg,rgba(0, 0, 0, 0.45),rgba(0, 0, 0, 0.35)),url(/console/img/immagini_sito/ristorante/fatto-da-noi/frittelle.jpg)");
                    $('#secondIMG').css("background-image", "url(/console/img/immagini_sito/ristorante/fatto-da-noi/pasta-e-fagioli.jpg)");
                    $('#thirdIMG').css("background-image", "url(/console/img/immagini_sito/ristorante/fatto-da-noi/millefoglie.jpg)");
