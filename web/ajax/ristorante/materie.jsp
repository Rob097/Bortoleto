        ...
        <script>
            ...
            switch (tipo) {
                ...
                case('La Carne'):
                    ...
                    $('#firstIMG').css("background-image", "linear-gradient(0deg,rgba(0, 0, 0, 0.45),rgba(0, 0, 0, 0.35)),url(/console/img/ristorante/la-carne/manzo-al-sesamo.jpg)");
                    $('#secondIMG').css("background-image", "url(/console/img/ristorante/la-carne/cervo.jpg)");
                    $('#thirdIMG').css("background-image", "url(/console/img/ristorante/la-carne/carne-cruda.jpg)");
                ...
                case('Fatto da noi'):
                    ...
                    $('#firstIMG').css("background-image", "linear-gradient(0deg,rgba(0, 0, 0, 0.45),rgba(0, 0, 0, 0.35)),url(/console/img/ristorante/fatto-da-noi/frittelle.jpg)");
                    $('#secondIMG').css("background-image", "url(/console/img/ristorante/fatto-da-noi/pasta-e-fagioli.jpg)");
                    $('#thirdIMG').css("background-image", "url(/console/img/ristorante/fatto-da-noi/millefoglie.jpg)");
                ...
                case('Dal Trentino'):
                    ...
                    $('#firstIMG').css("background-image", "linear-gradient(0deg,rgba(0, 0, 0, 0.45),rgba(0, 0, 0, 0.35)),url(/console/img/ristorante/dal-trentino/il-cappelli.jpg)");
                    $('#secondIMG').css("background-image", "url(/console/img/ristorante/dal-trentino/uovo-di-montagna-e-pasta-felicetti.jpg)");
                    $('#thirdIMG').css("background-image", "url(/console/img/ristorante/dal-trentino/orzo-goever.jpg)");
