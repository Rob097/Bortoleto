<%-- 
    Document   : alimenti-freschi
    Created on : 4 gen 2020, 16:04:42
    Author     : Roberto97
--%>
...
<body id="topPage" class="foo" data-spy="scroll" data-target=".sidebar">
    ...
    <div class="container">
        ...
        <section id="categorie"> 
            ...
            <c:choose>
                <c:when test="${!freshCat.isEmpty()}">
                    <c:set var="checkFreshCate" value="false"/>
                    <div class="card-columns">
                        <c:forEach items="${freshCat}" var="categoria" >
                            <c:if test="${!productdao.getAllProductsOfCategory(categoria.nome).isEmpty()}" >
                                <c:set var="checkFreshCate" value="true"/>
                    ...
                    <c:if test="${checkFreshCate eq false}">
