...
<html lang="en">
    ...
    <head>
        ...
        <meta property="og:title"         content="Dal Trentino - Prodotti della tradizione, stagionati o affumicati | Bortoleto" />
        <meta property="og:description"   content="Prodotti artigianali della tradizione Trentina, stagionati e affumicati. Spedizione in confezioni sottovuoto! Acquista ora i tuoi prodotti dal trentino!" />
        ...
        <title>Dal Trentino - Prodotti della tradizione, stagionati o affumicati | Bortoleto</title>
        <meta name="Description" content="Prodotti artigianali della tradizione Trentina, stagionati e affumicati. Spedizione in confezioni sottovuoto! Acquista ora i tuoi prodotti dal trentino!">
        <meta charset="UTF-8">
...
<body id="topPage" class="foo" data-spy="scroll" data-target=".sidebar">
    ...
    <div class="container">
        <section id="categorie"> 
            ...
            <c:choose>
                <c:when test="${!confCat.isEmpty()}">
                    <c:set var="checkConfCate" value="false"/>
                    <div class="card-columns">
                        <c:forEach items="${confCat}" var="categoria" >
                            <c:if test="${!productdao.getAllProductsOfCategory(categoria.nome).isEmpty()}" >
                                <c:set var="checkConfCate" value="true"/>
                                <a href="<c:url value="/categoria.jsp?id=${categoria.id}&nome=${categoria.nome.replace(' ', '-')}" />">
                                    <div class="card categoria-principale-box">
                                        <div class='img-cat'>
                                            <img class="card-img-top lazy" data-src="/${categoria.immagine}" alt="${categoria.nome}">
                                        </div>
                                        <div class="card-body">
                                            <h2 class="card-title">${categoria.nome}</h2>
                                            <p class="card-text sottotitoli">${productdao.getAllProductsOfCategory(categoria.nome).size()} Prodotti</p>
                                        </div>
                                    </div>
                                </a>
                            </c:if>
                    ...
                    <c:if test="${checkConfCate eq false}">
                        <p class="description">Non ci sono Categorie...</p>
                    </c:if>
                </c:when>
                <c:otherwise>
                    <p class="description">Non ci sono Categorie...</p>
